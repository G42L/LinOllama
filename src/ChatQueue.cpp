...
void ChatQueue::onModelUnloaded(const QString &model, bool success)
{
    ...
    m_ollamaClient->sendChatMessage(turn.conversationId, turn.model, turn.apiMessages, turn.think, turn.customNumCtx, turn.genOptions, turn.keepAliveSeconds, turn.tools);
    broadcastQueuePositions();
}
